...
namespace vect::core
{
    ...
    template <IsVecExpr L, Scalar R>
    auto operator==(const L &l, const R &r)
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonEqual>(l, ScalarExpr(r));
    }

    template <Scalar L, IsVecExpr R>
    auto operator==(const L &l, const R &r)
    {
        using ScalarExpr = VecScalar<L, R::dim>;
        return expr::BinaryOp<ScalarExpr, R, detail::ComparisonEqual>(ScalarExpr(l), r);
    }
    ...
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonNotEqual>(l, ScalarExpr(r));
    }
    ...
    {
        using ScalarExpr = VecScalar<L, R::dim>;
        return expr::BinaryOp<ScalarExpr, R, detail::ComparisonNotEqual>(ScalarExpr(l), r);
    }
    ...
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonGreater>(l, ScalarExpr(r));
    }
    ...
    {
        using ScalarExpr = VecScalar<L, R::dim>;
        return expr::BinaryOp<ScalarExpr, R, detail::ComparisonGreater>(ScalarExpr(l), r);
    }
    ...
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonLess>(l, ScalarExpr(r));
    }
    ...
    {
        using ScalarExpr = VecScalar<L, R::dim>;
        return expr::BinaryOp<ScalarExpr, R, detail::ComparisonLess>(ScalarExpr(l), r);
    }
    ...
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonGreaterEqual>(l, ScalarExpr(r));
    }
    ...
    {
        using ScalarExpr = VecScalar<L, R::dim>;
        return expr::BinaryOp<ScalarExpr, R, detail::ComparisonGreaterEqual>(ScalarExpr(l), r);
    }
    ...
    {
        using ScalarExpr = VecScalar<R, L::dim>;
        return expr::BinaryOp<L, ScalarExpr, detail::ComparisonLessEqual>(l, ScalarExpr(r));
    }
