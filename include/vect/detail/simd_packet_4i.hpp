...
namespace vect::detail
{
    struct Packet4i
    {
        ...
        {
            _mm_storeu_si128((__m128i *)dest, reg);
        }

        static auto load(const int *src) -> Packet4i
        {
            return {_mm_load_si128((__m128i *)src)};
        }
        static auto loadUnaligned(const int *src) -> Packet4i
        {
            return {_mm_loadu_si128((__m128i *)src)};
        }

        static auto broadcast(int val) -> Packet4i
        {
    ...
    inline auto dot(Packet4i a, Packet4i b) -> int
    {
    ...
    inline auto sum(Packet4i a) -> int
    {
        alignas(16) int vals[4];
    ...
    inline auto max_element(Packet4i a) -> int
    {
        alignas(16) int vals[4];
        _mm_store_si128((__m128i *)vals, a.reg);
        int max = vals[0];
    ...
    inline auto all(Packet4i a) -> bool
    {
    ...
    inline auto any(Packet4i a) -> bool
    {
        __m128i zero = _mm_setzero_si128();
        __m128i cmp = _mm_cmpeq_epi32(a.reg, zero);
        alignas(16) int vals[4];
